function dhtmlXContainer(obj) {
	...
	*/
	this.obj.attachStatusBar = function() {
		...
		sbObj.onselectstart = function(e) { e=e||event; if (e.preventDefault) e.preventDefault(); else e.returnValue = false; return false; }
	...
	*/
	...
	this.obj._dhxContDestruct = function() {
		...
		for (var a in this.vs) {
			...
			if (dhtmlx.detaches) {
				for (var b in dhtmlx.detaches) dhtmlx.detaches[b](this.vs[a]);
			}
