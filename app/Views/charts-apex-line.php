...
<body>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="line-chart" class="apex-charts" data-colors="#f9c851"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="line-chart-datalabel" class="apex-charts" data-colors="#35b8e0,#5b69bc">
                                    </div>
                                </div>
                            </div>
                            <!-- end card body-->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="line-chart-syncing2" data-colors="#5b69bc"></div>
                                <div dir="ltr">
                                    <div id="line-chart-syncing" class="apex-charts" data-colors="#35b8e0"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="line-chart-missing" class="apex-charts"
                                        data-colors="#f9c851,#10c469,#39afd1"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="line-chart-dashed" class="apex-charts"
                                        data-colors="#35b8e0,#10c469,#39afd1"></div>
                                </div>
                            </div>
                            <!-- end card body-->
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div dir="ltr">
                                    <div id="chart-line2" class="apex-charts" data-colors="#5b69bc"></div>
    ...
    <script src="/js/components/chart-apex-line.js"></script>
