                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-2">
                                    ...
                                    <img src="/images/users/avatar-2.jpg" class="avatar-lg rounded-top"
                                        alt="rounded-top">
                                    <img src="/images/users/avatar-2.jpg" class="avatar-lg rounded-end"
                                        alt="rounded-end">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-2">
                                    <img src="/images/users/avatar-4.jpg" class="avatar-lg rounded-0"
                                        alt="rounded-0">
                                    <img src="/images/users/avatar-4.jpg" class="avatar-lg rounded-1"
                                        alt="rounded-1">
                                    <img src="/images/users/avatar-4.jpg" class="avatar-lg rounded-2"
                                        alt="rounded-2">
                                    <img src="/images/users/avatar-4.jpg" class="avatar-lg rounded-3"
                                        alt="rounded-3">
                                    <img src="/images/users/avatar-4.jpg" class="avatar-lg rounded-4"
                                        alt="rounded-4">
                                    <img src="/images/users/avatar-4.jpg" class="avatar-lg rounded-5"
                                        alt="rounded-5">
                                </div>
                            </div> <!-- end card-body -->
                        </div> <!-- end card-->
