...
<head>
    <?php echo view("partials/title-meta", array("title" => "Slope Charts")) ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <?php echo view("partials/page-title", array("title" => "Slope Charts", "subTitle" => "Apex")) ?>
    ...
    <script src="/js/components/chart-apex-slope.js"></script>
