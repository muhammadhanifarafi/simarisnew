                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="CustomIconheadingTwo">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                Accordion item with remix icons
                                                <i
                                                    class="ri-add-circle-line accordion-icon accordion-icon-on avatar-xxs me-n1"></i>
                                                <i class="ri-subtract-line accordion-icon accordion-icon-off avatar-xxs me-n1"></i>
                                            </button>
                                        </h2>
