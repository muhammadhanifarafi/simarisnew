...
<head>
    <?php echo view("partials/title-meta", array("title" => "Invoices")) ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom justify-content-between d-flex flex-wrap align-items-center gap-2">
                                ...
                                <a href="apps-invoice-create" class="btn btn-primary"><i
                                ...
                                <table class="table table-hover text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2026</a></span></td>
                                            <td>Fashion</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2025</a></span></td>
                                            <td>Electronics</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2024</a></span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2023</a></span></td>
                                            <td>Electronics</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2022</a></span></td>
                                            <td>Electronics</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2021</a></span></td>
                                            <td>Watches</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2020</a></span></td>
                                            <td>Bags</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2019</a></span></td>
                                            <td>Cloth's</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2018</a></span></td>
                                            <td>Sofa</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="fw-semibold"><a href="apps-invoice-details" class="text-reset">#WA-2017</a></span></td>
                                            <td>Shoes</td>
