...
<head>
    <?php echo view("partials/title-meta", array("title" => "Master Penyebab - Kamus Risiko")) ?>
            ...
            <div class="page-container">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Master Penyebab - Kamus Risiko</h4>
                                <!-- Add "Tambah" button -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addDataForm">
                        ...
                        <div class="mb-3">
                            <label for="nama_penyebab" class="form-label">Penyebab</label>
    ...
    <script>
        ...
        function datatables() {
            table = $('#scroll-horizontal-datatable').DataTable({
                        ...
                        "bDestroy": true,
                        "ajax": {
                            "url": "<?php echo base_url() . 'master/master_profil_penyebab/data' ?>",
                            "type": "GET",
                            "dataSrc": "data"
                        },
                        "pageLength": 10,
        ...
        $(document).ready(function() {
            $('#saveDataBtn').click(function() {
                ...
                $.ajax({
                    url: '<?= base_url('master/master_profil_penyebab/save') ?>',
                    type: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.edit-btn', function() {
                var id = $(this).data('id');
                $.ajax({
                    url: '<?= base_url('master/master_profil_penyebab/edit') ?>/' + id,
                    type: 'GET',
                    success: function(response) {
                        var data = response.data;
                        $('#modalTitle').text('Edit Data');
                        $('#data_id').val(data.id);
                        $('#nama_penyebab').val(data.nama_penyebab);
                        $('#ket').val(data.ket);
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?= site_url('master/master_profil_penyebab/delete') ?>/' + id,
                            type: 'POST',
                            success: function(response) {
                                if (response.status === 'success') {
