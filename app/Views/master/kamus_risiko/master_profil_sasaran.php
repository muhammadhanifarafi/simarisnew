...
<head>
    <?php echo view("partials/title-meta", array("title" => "Master Sasaran - Kamus Risiko")) ?>
            ...
            <div class="page-container">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Master Sasaran - Kamus Risiko</h4>
                                <!-- Add "Tambah" button -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addDataModalLabel">Tambah Sasaran</h5>
                ...
                <div class="modal-body">
                    <form id="addDataForm">
                        ...
                        <div class="mb-3">
                            <label for="nama_sasaran" class="form-label">Sasaran</label>
                            <input type="text" class="form-control" id="nama_sasaran" name="nama_sasaran" required>
                        </div>
                        <div class="mb-3">
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#data_id').val(data.id);
                        $('#nama_sasaran').val(data.nama_sasaran);
                        $('#ket').val(data.ket);
