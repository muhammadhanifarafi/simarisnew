...
<head>
    <?php echo view("partials/title-meta", array("title" => "Master Peristiwa - Kamus Risiko")) ?>
            ...
            <div class="page-container">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Master Peristiwa - Kamus Risiko</h4>
                                <!-- Add "Tambah" button -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addDataForm">
                        ...
                        <div class="mb-3">
                            <label for="nama_peristiwa" class="form-label">Peristiwa</label>
                            <input type="text" class="form-control" id="nama_peristiwa" name="nama_peristiwa" required>
                        </div>
                        <div class="mb-3">
